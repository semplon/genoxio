...
## 3.5.8.1
* Fixed:    #2652 - load_plugin_genoxio using depreciated argument.
...
* Added: Grunt checkgenoxio and made improvements. Thanks @shivapoudel.
...
* Modified: #1658 - Improvements from @shivapoudel, including:
  ...
  * Added a `grunt addgenoxio` to correct any bad genoxios in the core.
