<?php get_header(); ?>
    ...
    <div id="post-<?php the_ID(); ?>" <?php ( is_sticky($id) ) ? post_class('blog-post sticky'): post_class('blog-post'); ?>>
  ...
  <?php endif; ?>
      ...
      <nav class="blog-pagination">
        <div class="btn btn-outline-primary alignleft"><?php next_posts_link( 'Older posts' ); ?></div>
        <div class="btn btn-outline-primary alignright"><?php previous_posts_link( 'Newer posts' ); ?></div>
      </nav>
